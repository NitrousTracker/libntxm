...
SoundEmulator::SoundEmulator() { setRenderFrequency(32728); }
...
void ntxm_sound_channel_stop(int channel) { emu.playing[channel] = false; }

bool ntxm_sound_channel_is_playing(int channel) { return emu.playing[channel]; }
